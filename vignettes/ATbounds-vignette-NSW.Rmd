...
Again the results are a bit sensitive to the choice of $q$ and it is likely to be driven by a relative small sample size.
...
Overall, the empirical results suggest that PSID2 controls are substantially different from the treated units such that the unconfoundedness assumption does not provide any meaningful restriction once the overlap condition is dropped and the logit propensity score can be misspecified.
